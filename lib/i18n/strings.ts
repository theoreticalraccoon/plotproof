...
const en: Dict = {
  ...
  sensor_source_magicbit: "ESP32 sensor, over USB",
...
const si: Dict = {
  ...
  sensor_connect_body: "ESP32 සංවේදකය මෙම පරිගණකයට සම්බන්ධ කර එහි port එක තෝරන්න. කියවීම මෙම උපාංගයේම රැඳේ; කිසිවක් උඩුගත නොවේ.",
...
const ta: Dict = {
  ...
  sensor_connect_body: "ESP32 உணரியை இந்தக் கணினியில் இணைத்து, அதன் port-ஐத் தேர்வுசெய்யவும். அளவீடு இந்தச் சாதனத்திலேயே இருக்கும்; எதுவும் பதிவேற்றப்படவில்லை.",
